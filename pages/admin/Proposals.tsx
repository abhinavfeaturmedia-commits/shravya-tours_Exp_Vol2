                            ...
                            <div key={proposal.id} className="bg-white dark:bg-[#1A2633] rounded-2xl border border-slate-200 dark:border-slate-800 p-5 shadow-sm hover:shadow-md transition-all group">
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="relative group/actions">
                                        ...
                                        <div className="absolute right-0 top-full mt-1 w-36 bg-white dark:bg-[#1A2633] border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl overflow-hidden hidden group-hover/actions:block z-20">
                                            <button onClick={() => navigate(`/admin/proposals/${proposal.id}`)} className="w-full text-left px-4 py-2 text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2">
                                                <Edit size={14} /> Edit
                                            </button>
                                            <button 
                                                onClick={() => {
                                            ...
                                            <button onClick={() => handleDelete(proposal.id)} className="w-full text-left px-4 py-2 text-xs font-bold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 flex items-center gap-2">

...
export const About: React.FC = () => {
    ...
    const goals = [
        ...
        },
        {
            ...
            icon: "verified",
            description: "Establish SHRAWELLO Travel Hub and Events LLP as a trusted and preferred travel brand, recognized for quality, reliability, and customer-centric services."
        },
        {
                ...
                <div className="relative h-[400px] flex items-center justify-center text-center px-4">
                    <div className="absolute inset-0 bg-slate-900">
                        <OptimizedImage
                            ...
                            alt="About SHRAWELLO Travel Hub and Events LLP"
                            className="w-full h-full opacity-40 object-cover"
                        />
                    </div>
                    <div className="relative z-10 max-w-4xl">
                        <h1 className="text-4xl md:text-6xl font-black text-white mb-6">About SHRAWELLO Travel Hub and Events LLP</h1>
                ...
                <div className="container mx-auto px-6 -mt-20 relative z-20">
                    ...
                    <div className="bg-white dark:bg-slate-800 p-8 md:p-12 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 mb-20">
                        ...
                        <div className="space-y-6 text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                            <p>
                                SHRAWELLO Travel Hub and Events LLP is a trusted travel company dedicated to creating memorable and personalized travel experiences. With a strong focus on comfort, safety, and customer satisfaction, we deliver seamless travel solutions tailored to every journey.
                            </p>
                            <p>

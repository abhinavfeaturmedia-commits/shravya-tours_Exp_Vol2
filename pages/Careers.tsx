            ...
            <div className="bg-slate-50 dark:bg-slate-900 min-h-screen py-24">
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-16 animate-in slide-in-from-bottom-5">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400">At SHRAWELLO Travel Hub and Events LLP, we are always looking for passionate individuals to join our team.</p>
                    </div>

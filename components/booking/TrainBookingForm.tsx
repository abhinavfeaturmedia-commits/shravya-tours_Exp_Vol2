...
type TrainFormData = z.infer<typeof trainBookingSchema>;

interface TrainBookingFormProps {
    onSubmit: (data: TrainBookingData) => void;
}
...
export const TrainBookingForm: React.FC<TrainBookingFormProps> = ({ onSubmit }) => {
    const today = new Date().toISOString().split('T')[0];

    const { register, handleSubmit, formState: { errors }, setValue, watch } = useForm<TrainFormData>({
        resolver: zodResolver(trainBookingSchema),
        defaultValues: { from: '', to: '', date: '', passengers: 1, classType: 'Sleeper' }
    });
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 md:gap-4 items-end animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="sm:col-span-1 lg:col-span-2 relative group">
                    ...
                    <div className="relative">
                        <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors text-lg">train</span>
                        <input
                            {...register('from')}
                ...
                <div className="sm:col-span-1 lg:col-span-2 relative group">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="AC First Class">AC 1st Class</option>
